...
Six accounts with missing money, an extra collection, higher margins, a reversed payment and normal split payments.

5 issues on 3 accounts. Shortfalls total 1,900.00 and extra receipts total 800.00; the overall difference is -1,100.00.
...
- SYN-L000501 has a missing payment and a higher margin. SYN-L000502 has an extra collection and a higher margin. Five issues therefore affect three accounts, not five.
- SYN-L000504 has a 900.00 entry followed by a -900.00 reversal. Net cash is zero, so the missing-payment rule applies.
- SYN-L000503 pays 500.00 and 700.00 against 1,200.00 due. This split payment must not produce a duplicate flag.
- Missing amounts and extra amounts partly cancel in the total. Looking at each account reveals both.
...
| Amount due | 5000.00 |
| Net money received | 3900.00 |
| Investor-reported cash | 3900.00 |
| Received minus due | -1100.00 |
| Total account shortfalls | 1900.00 |
| Total account excess receipts | 800.00 |
